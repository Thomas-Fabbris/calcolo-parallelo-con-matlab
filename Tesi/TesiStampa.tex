...
\epigraph{\textit{La cosa migliore che puoi fare è ottenere il massimo da te stesso.}}{Wallace D. Wattles}
% Indice
\tableofcontents
\mainmatter
...
\input{Capitoli/Capitolo 1/Introduzione.tex}
...
\input{Capitoli/Capitolo 2/Introduzione.tex}
...
\input{Capitoli/Capitolo 3/Introduzione.tex}
% Paragrafo 3.1: Sistemi lineari
\section{Sistemi lineari}
\label{par:sistemiLineari}
\input{Capitoli/Capitolo 3/SistemiLineari.tex}
\nocite{Quarteroni2002}
\nocite{Quarteroni1997}
% Paragrafo 3.2: Risoluzione di sistemi lineari mediante metodi iterativi
...
\input{Capitoli/Capitolo 3/AlgoritmoJacobi.tex}
...
\input{Capitoli/Capitolo 3/ApplicazioneJacobi.tex}
...
\input{Capitoli/Appendice/CodiceJacobi.tex}
\end{appendix}
