...
\begin{esempio}[Analisi prestazionale di un problema di grandi dimensioni]
    ...
    \end{table}
\end{esempio}
L'esempio \ref{esempio:analisiGrandiDimensioni} evidenzia la questione fondamentale attorno al calcolo parallelo: aumentare la velocit\`a di esecuzione
...
\begin{esempio}[Bilanciamento del carico di lavoro per un problema di grandi dimensioni]
