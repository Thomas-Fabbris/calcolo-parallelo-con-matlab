...
nel capitolo \ref{cap:unLinguaggioPerIlCalcoloParalleloMATLAB} e sull'applicazione dei concetti teorici alla risoluzione per via numerica di sistemi di equazioni lineari di grandi dimensioni nel capitolo \ref{cap:metodoJacobiParallelo}.
...
al fine di ottenere un miglioramento delle prestazioni.\newline
Riguardo a questo punto, vorremmo ringraziare il \textit{Control Systems and Automation Laboratory} dell'Universit\`a degli Studi 
di Bergamo per aver messo a disposizione delle \textit{workstation} su cui effettuare le simulazioni numeriche, i cui risultati sono stati esposti nel paragrafo \ref{par:applicazioneMetodoJacobi}.
...
di software parallelo di qualit\'a: alla padronanza delle tecniche proprie del calcolo parallelo, devono essere 
