...
A questo proposito, dobbiamo precisare che \`e prevista la possibilit\`a di definire distribuzioni dei dati alternative e che, molto spesso, il partizionamento degli elementi viene manipolato implicitamente dall'esecuzione di alcune operazioni tipiche del calcolo parallelo,
come l'operazione di riduzione, utile a trasformare un \textit{array} distribuito in un singolo oggetto.
