%!TeX root = ../../Tesi.tex
Nell'appendice \ref{app:codiceSorgenteJacobi} riportiamo un'implementazione del metodo di Jacobi che trae vantaggio delle funzionalit\`a del linguaggio MATLAB per il 
...
In accordo con i principi di \textit{design} del processo di parallelizzazione di MATLAB, esposti nel paragrafo \ref{par:parallelComputingToolbox}, il programma \`e 
